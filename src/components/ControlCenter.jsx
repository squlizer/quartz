    ...
    >
      ...
      >
        ...
        <div className="flex gap-4">
          <div className="w-1/2 h-40 bg-white/10 backdrop-blur-3xl rounded-[28px] p-4 grid grid-cols-2 gap-3 border border-white/20 shadow-2xl relative overflow-hidden group">
            <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent pointer-events-none" />
            <div className="flex items-center justify-center bg-white/10 text-white rounded-full h-12 w-12 text-xl active:bg-orange-500 transition-colors z-10"><Plane size={24} className="-rotate-45" /></div>
            <div className="flex items-center justify-center bg-blue-500 text-white rounded-full h-12 w-12 text-xl shadow-[0_0_20px_rgba(59,130,246,0.4)] z-10"><Wifi size={24} strokeWidth={2.5} /></div>
            <div className="flex items-center justify-center bg-blue-500 text-white rounded-full h-12 w-12 text-xl shadow-[0_0_20px_rgba(59,130,246,0.4)] z-10"><Bluetooth size={24} strokeWidth={2.5} /></div>
            <div className="flex items-center justify-center bg-green-500 text-white rounded-full h-12 w-12 text-xl shadow-[0_0_20px_rgba(34,197,94,0.4)] z-10"><Radio size={24} strokeWidth={2.5} /></div>
          </div>
          <div className="w-1/2 h-40 bg-white/10 backdrop-blur-3xl rounded-[28px] p-5 flex flex-col justify-between border border-white/20 shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent pointer-events-none" />
            ...
            <div className="flex justify-between text-white items-center px-1 z-10">
        ...
        {/* Notifications Preview - NEW */}
        <div className="w-full bg-white/5 backdrop-blur-3xl rounded-[28px] p-4 border border-white/10 shadow-lg flex items-center gap-4">
          <div className="w-10 h-10 rounded-full bg-red-500 flex items-center justify-center text-white shadow-lg shrink-0">
            <span className="font-bold text-lg">!</span>
          </div>
          <div className="flex flex-col text-left">
            <span className="text-white text-sm font-semibold">Notifications</span>
            <span className="text-white/50 text-xs">No new notifications</span>
          </div>
        </div>
